...
'''
{"properties": 
    {"device": {"enum": ["gpu", "cpu"], "title": "Device", "type": "string"}, 
     "device_ids": {"items": {"type": "integer"}, "title": "Device Ids", "type": "array"}, 
     "learning_rate": {"title": "Learning Rate", "type": "number"}}, 
 "required": ["device", "device_ids", "learning_rate"], "title": "TrainConfig", "type": "object"}
'''